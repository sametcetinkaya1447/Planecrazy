...
antiboomz0r = {"New Yeller",nil,0.4,0.7,true,Color3.new(1,1,.95),Color3.new(1, 0, 0)},
...
samet_gazi = {"Really black",nil,0,0,false},
...
local wing = workspace.samet_gazi.tailpro:GetChildren()
if #wing <= 2 then
    warn("Not enough wing parts found!")
    return
end
